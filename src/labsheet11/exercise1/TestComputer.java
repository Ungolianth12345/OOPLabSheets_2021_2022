...
public class TestComputer {
    public static void main(String[] args) {
        double totalPrice = 0;
        StringBuilder listOver500Euro= new StringBuilder();
        StringBuilder listOfTablets = new StringBuilder();
        ...
        for (Computer c:allComputers) {
            ...
            if (c.getPrice() > 500)
                listOver500Euro.append(c).append("\n");
            if (c.getType().equals("Tablet"))
                listOfTablets.append(c).append("\n");
