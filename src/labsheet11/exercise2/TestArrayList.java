...
public class TestArrayList{
    ...
    public static void viewProducts(ArrayList<Product> allProducts){
        StringBuilder allProductData= new StringBuilder();
        Product pr;
        ...
        for (Product allProduct : allProducts) {
            pr = allProduct;
            if (pr != null)
                allProductData.append(pr).append("\n");
        }

        JOptionPane.showMessageDialog(null, allProductData.toString(),
